...
<script>
		var square_appId = "{$square_application_id}";
		var square_locationId = "{$square_location_id}"
		var callback_class = "{$callback_class}";
	...
	{literal}
		  ...
		  async function createPayment(token) {
			  ...
			  var fd = new FormData();
			  fd.append("class", callback_class);
			  fd.append("function", callback_function);
