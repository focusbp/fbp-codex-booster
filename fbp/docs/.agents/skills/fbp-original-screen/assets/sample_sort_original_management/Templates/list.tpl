<div class="original_screen_page">
    ...
    <div class="original_screen_toolbar">
        <p class="original_screen_toolbar_note">ドラッグで並び替えできます。表示件数: {$count}</p>
        <button type="button" class="ajax-link button_link" data-class="sample_sort_original_management" data-function="add_dialog">追加</button>
    </div>
